...
const services: ServiceContent[] = [
  {
    ...
    longDescription: `Jeg udvikler komplette webløsninger fra bunden med fokus på hastighed, sikkerhed og brugeroplevelse. Med Laravel som backend og Nuxt som frontend får du en moderne, vedligeholdelsesvenlig løsning der kan vokse med din virksomhed.
...
Jeg bruger en tech stack der er battle-tested af nogle af verdens største virksomheder: Laravel til robust backend-logik og Nuxt/Vue til hurtige, interaktive brugerflader. Kombinationen giver dig det bedste fra begge verdener - enterprise-grade stabilitet med startup-agtig hastighed.`,
    features: [
      'Responsivt design der fungerer perfekt på mobil, tablet og desktop',
      'SEO-optimeret arkitektur med server-side rendering',
      'Lynhurtig indlæsningstid med static site generation',
      'Sikker autentificering med Laravel Sanctum eller Passport',
      'Integration med tredjepartstjenester (betalinger, CRM, email)',
      'Strukturerede data for bedre Google-visning'
    ],
    technologies: ['Laravel', 'Nuxt', 'Vue.js', 'TypeScript', 'Tailwind CSS', 'PostgreSQL'],
    benefits: [
      'Skræddersyet løsning der matcher dine forretningsbehov præcist',
      'Skalerbar arkitektur der vokser med din virksomhed',
      'Løbende support og vedligeholdelse efter lancering',
      'Dokumenteret kode der er nem at overtage'
    ],
    icon: 'i-lucide-code',
    relatedServices: ['frontend', 'backend', 'webapp'],
    process: [
    ...
    useCases: [
      'Virksomhedswebsites med CMS til nem redigering',
      'Landingssider til marketingkampagner',
      'Kundeportaler med login og personligt indhold',
      'Booking- og reservationssystemer',
      'Medlemssites med abonnement'
    ],
    faq: [
    ...
    seo: {
      title: 'Webudvikling med Laravel & Nuxt | Mattias Kieler',
      description: 'Professionel webudvikling med Laravel og Nuxt. Få en hurtig, sikker og skalerbar webløsning skræddersyet til din virksomhed. Freelance webudvikler med 10+ års erfaring.',
      ogTitle: 'Webudvikling med Laravel & Nuxt',
      ogDescription: 'Skræddersyede webløsninger bygget med moderne teknologier for optimal performance og skalerbarhed.'
    }
  },
  {
    slug: 'webapp',
    ...
    longDescription: `Web applikationer er software der kører i browseren og giver brugere mulighed for at udføre komplekse opgaver - fra at administrere kunder til at analysere data i real-time.
...
Jeg specialiserer mig i at bygge SaaS-produkter (Software as a Service), interne værktøjer og kundeportaler. Med Laravel og Nuxt som fundament kan jeg levere applikationer der håndterer tusindvis af samtidige brugere, komplekse workflows og real-time data.`,
    features: [
      'Multi-tenant arkitektur til SaaS med isolerede kundedata',
      'Real-time opdateringer med WebSockets',
      'Rollebaseret adgangskontrol (RBAC)',
      'Avancerede dashboards med interaktive grafer og rapporter',
      'API-først design for nem integration',
      'Offline-funktionalitet med service workers'
    ],
    technologies: ['Laravel', 'Nuxt', 'Vue.js', 'WebSockets', 'Redis', 'PostgreSQL', 'Inertia.js'],
    benefits: [
      'Skalerbar til tusindvis af brugere uden performance-tab',
      'Sikker datahåndtering med encryption og audit logs',
      'Nem integration med eksisterende systemer via API',
      'Reducerede driftsomkostninger ved at automatisere manuelle processer'
    ],
    icon: 'i-lucide-layout-dashboard',
    relatedServices: ['api-udvikling', 'backend', 'webudvikling'],
    process: [
    ...
    useCases: [
      'SaaS-produkter med abonnementsmodel',
      'CRM-systemer tilpasset din branche',
      'Projekt- og opgavestyring',
      'Booking- og kalendersystemer',
    ...
    seo: {
      title: 'Web Applikationer & SaaS Udvikling | Mattias Kieler',
      description: 'Udvikling af skræddersyede web applikationer, SaaS-platforme og kundeportaler. Skalerbare løsninger med Laravel og Nuxt. Kontakt for en uforpligtende snak.',
      ogTitle: 'Web Applikationer & SaaS Udvikling',
      ogDescription: 'Kraftfulde web applikationer til din virksomhed. SaaS-platforme, dashboards og kundeportaler.'
    }
  },
  {
    slug: 'webshop',
    ...
    longDescription: `En webshop er mere end bare et produktkatalog online. Det er en salgsmotor der skal overbevise besøgende om at købe - og gøre det nemt for dem at gennemføre købet.
...
Uanset om du vil have en custom-bygget løsning med Laravel, en WooCommerce-baseret shop, eller en headless Shopify-integration, hjælper jeg dig med at vælge den rigtige platform til dine behov og budget.`,
    features: [
      'Hurtig checkout-proces med færrest mulige trin',
      'Integration med Stripe, Quickpay, MobilePay og andre gateways',
      'Automatisk lagerstyring og ordrehåndtering',
      'Produktkatalog med varianter, attributter og filtrering',
      'Kundekonti med ordrehistorik og ønskelister',
      'Abandoned cart emails og remarketing-integration'
    ],
    technologies: ['Laravel', 'Nuxt', 'Stripe', 'Shopify', 'WooCommerce', 'Quickpay'],
    benefits: [
      'Højere konverteringsrate gennem optimeret brugeroplevelse',
      'Lavere cart abandonment med streamlined checkout',
      'Skalerbar til Black Friday og andre spidsbelastninger',
      'Automatiserede processer sparer tid på ordrehåndtering'
    ],
    icon: 'i-lucide-shopping-cart',
    relatedServices: ['webudvikling', 'wordpress', 'frontend'],
    process: [
    ...
    useCases: [
      'B2C webshops med fysiske produkter',
      'B2B shops med kundespecifikke priser',
      'Digitale produkter og downloads',
      'Abonnementsbaseret salg (subscription boxes)',
      'Markedspladser med flere sælgere'
    ],
    faq: [
    ...
    seo: {
      title: 'Webshop Udvikling & E-commerce | Mattias Kieler',
      description: 'Professionel webshop udvikling med fokus på konvertering. WooCommerce, Shopify og custom e-commerce løsninger. Få en webshop der sælger.',
      ogTitle: 'Webshop & E-commerce Udvikling',
      ogDescription: 'E-commerce løsninger der konverterer. Online butikker med fokus på brugeroplevelse og hastighed.'
    }
  },
  {
    slug: 'wordpress',
    ...
    longDescription: `WordPress driver over 40% af alle websites på internettet. Det er et modent, fleksibelt CMS med et enormt økosystem af plugins og themes - og det er ofte det rigtige valg for virksomheder der vil have nem indholdsstyring.
...
For virksomheder der vil have det bedste fra begge verdener, tilbyder jeg også headless WordPress-løsninger, hvor WordPress fungerer som CMS bag en lynhurtig Nuxt-frontend.`,
    features: [
      'Custom theme udvikling med moderne best practices',
      'Plugin-udvikling til specifikke behov',
      'Headless WordPress med Nuxt eller Next.js frontend',
      'WooCommerce opsætning og tilpasning',
      'Performance-optimering af eksisterende WordPress-sites',
      'Sikkerhedshærdning og malware-fjernelse'
    ],
    technologies: ['WordPress', 'PHP', 'WooCommerce', 'ACF Pro', 'Nuxt', 'REST API', 'GraphQL'],
    benefits: [
      'Kendt CMS som redaktører allerede kender',
      'Stort plugin-økosystem til næsten enhver funktion',
      'Nem indholdsstyring uden teknisk viden',
      'Lavere vedligeholdelsesomkostninger end custom CMS'
    ],
    icon: 'i-simple-icons-wordpress',
    relatedServices: ['webudvikling', 'webshop', 'frontend'],
    process: [
    ...
    useCases: [
      'Virksomhedswebsites med nyheder og blog',
      'Medlemssites med beskyttet indhold',
      'Online magasiner og medier',
      'Porteføljesites for kreative',
      'WooCommerce webshops',
      'Multisite-netværk for franchise eller koncerner'
    ],
    faq: [
    ...
    seo: {
      title: 'WordPress Udvikling & Custom Themes | Mattias Kieler',
      description: 'Professionel WordPress udvikling med custom themes og plugins. Headless WordPress, WooCommerce og performance-optimering. Freelance WordPress-ekspert.',
      ogTitle: 'WordPress Udvikling & Custom Themes',
      ogDescription: 'Custom themes, plugins og headless WordPress løsninger. Få mest muligt ud af verdens mest populære CMS.'
    }
  },
  {
    slug: 'api-udvikling',
    ...
    longDescription: `Et API (Application Programming Interface) er den usynlige infrastruktur der forbinder dine systemer og muliggør dataudveksling mellem applikationer. Det er fundamentet for alt fra mobile apps til tredjepartsintegrationer.
...
God API-design handler om mere end bare at returnere data. Det handler om konsistens, versionering, fejlhåndtering og dokumentation der gør det nemt for andre udviklere at integrere.`,
    features: [
      'REST API design med OpenAPI/Swagger dokumentation',
      'GraphQL API\'er med type-safety og introspection',
      'OAuth2 og JWT-baseret autentificering',
      'Rate limiting og caching for høj performance',
      'Automatisk genereret dokumentation',
      'Versionering og backwards compatibility'
    ],
    technologies: ['Laravel', 'GraphQL', 'OpenAPI', 'Redis', 'PostgreSQL', 'JWT', 'OAuth2'],
    benefits: [
      'Nem integration for interne og eksterne udviklere',
      'Skalerbar arkitektur der håndterer høj trafik',
      'God developer experience med klar dokumentation',
      'Fremtidssikret med versionering'
    ],
    icon: 'i-lucide-plug',
    relatedServices: ['backend', 'webapp', 'mobil-app'],
    process: [
    ...
    useCases: [
      'Backend til mobile apps (iOS/Android)',
      'Integration mellem interne systemer',
      'Tredjeparts-integrationer for partnere',
      'Microservices-arkitektur',
      'Headless CMS API\'er',
      'IoT device kommunikation'
    ],
    faq: [
    ...
    seo: {
      title: 'API Udvikling - REST & GraphQL | Mattias Kieler',
      description: 'Professionel API udvikling med REST og GraphQL. Sikre, veldokumenterede API\'er med Laravel. Få et solidt fundament til dine applikationer.',
      ogTitle: 'API Udvikling - REST & GraphQL',
      ogDescription: 'Robuste API\'er til dine applikationer. REST og GraphQL med fokus på sikkerhed og dokumentation.'
    }
  },
  {
    slug: 'frontend',
    ...
    longDescription: `Frontend er det første brugerne møder. Det er den synlige del af din applikation - knapperne de klikker på, formularerne de udfylder, og animationerne der gør oplevelsen levende.
...
Min primære stack er Vue.js og Nuxt, men jeg arbejder også med React og Next.js. Uanset framework er fokus det samme: ren kode, god performance og en brugeroplevelse der føles naturlig.`,
    features: [
      'Komponent-baseret arkitektur med genbrugelige UI-elementer',
      'Server-side rendering (SSR) for hurtig first paint og SEO',
      'Static site generation (SSG) for maksimal hastighed',
      'Smooth animationer og micro-interactions',
      'Tilgængelighed (WCAG 2.1) for alle brugere',
      'Progressive Web App (PWA) funktionalitet'
    ],
    technologies: ['Vue.js', 'Nuxt', 'React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion'],
    benefits: [
      'Lynhurtig indlæsningstid der reducerer bounce rate',
      'God SEO gennem server-side rendering',
      'Moderne brugeroplevelse der matcher brugernes forventninger',
      'Vedligeholdelsesvenlig kode med komponent-arkitektur'
    ],
    icon: 'i-lucide-palette',
    relatedServices: ['webudvikling', 'webapp', 'backend'],
    process: [
    ...
    useCases: [
      'Marketing websites og landingssider',
      'Admin dashboards og backoffice',
      'E-commerce produktsider',
    ...
    seo: {
      title: 'Frontend Udvikling - Vue, Nuxt & React | Mattias Kieler',
      description: 'Professionel frontend udvikling med Vue.js, Nuxt og React. Hurtige, tilgængelige brugergrænseflader med fokus på performance og brugeroplevelse.',
      ogTitle: 'Frontend Udvikling - Vue, Nuxt & React',
      ogDescription: 'Moderne frontend udvikling med fokus på hastighed og brugeroplevelse. Vue, Nuxt, React og TypeScript.'
    }
  },
  {
    slug: 'backend',
    ...
    longDescription: `Backend er hjertet i din applikation - den usynlige motor der håndterer forretningslogik, lagrer data sikkert, og sørger for at alt fungerer som det skal.
...
God backend-udvikling handler om mere end bare at få tingene til at virke. Det handler om sikkerhed, skalerbarhed, testbarhed og performance under pres. Jeg designer systemer der holder, også når din virksomhed vokser.`,
    features: [
      'RESTful API design med clean architecture',
      'Database design og query-optimering',
      'Køsystemer til asynkrone opgaver',
      'Caching strategier med Redis',
      'Logging, monitoring og alerting',
      'Scheduled tasks og background jobs'
    ],
    technologies: ['Laravel', 'PHP', '.NET', 'C#', 'Node.js', 'PostgreSQL', 'MySQL', 'Redis'],
    benefits: [
      'Høj oppetid med fejltolerant arkitektur',
      'Skalerbar til millioner af requests',
      'Sikker datahåndtering med encryption og auditing',
      'Testbar kode der reducerer bugs i produktion'
    ],
    icon: 'i-lucide-server',
    relatedServices: ['api-udvikling', 'webapp', 'webudvikling'],
    process: [
    ...
    useCases: [
      'API\'er til web og mobile apps',
      'Datapipelines og ETL-processer',
      'Integrationslag mellem systemer',
      'Admin-backends og CMS',
      'Background processing og scheduled jobs',
    ...
    seo: {
      title: 'Backend Udvikling med Laravel & PHP | Mattias Kieler',
      description: 'Professionel backend udvikling med Laravel og PHP. Skalerbare, sikre systemer der håndterer forretningslogik og data. Erfaren freelance backend-udvikler.',
      ogTitle: 'Backend Udvikling med Laravel & PHP',
      ogDescription: 'Solide backend løsninger med Laravel. Skalerbare og sikre systemer til din virksomhed.'
    }
  },
  {
    slug: 'mobil-app',
    ...
    longDescription: `En mobil app giver dig direkte adgang til dine brugeres lommer. Med push-notifikationer, offline-funktionalitet og native device-features kan du skabe oplevelser der ikke er mulige på web.
...
Cross-platform betyder ikke kompromis på kvalitet. Moderne frameworks leverer 60fps animationer, adgang til kamera, GPS, biometri og alle de native features dine brugere forventer.`,
    features: [
      'Én kodebase til iOS og Android',
      'Native performance med 60fps animationer',
      'Offline-first med lokal data sync',
      'Push notifikationer og deep linking',
      'Biometrisk login (Face ID, fingeraftryk)',
      'App Store og Play Store deployment'
    ],
    technologies: ['Flutter', 'Dart', 'React Native', 'Firebase', 'Expo', 'SQLite'],
    benefits: [
      'Hurtigere time-to-market end native udvikling',
      'Lavere udviklingsomkostninger med én kodebase',
      'Konsistent brugeroplevelse på tværs af platforme',
      'Nemmere vedligeholdelse med shared codebase'
    ],
    icon: 'i-lucide-smartphone',
    relatedServices: ['api-udvikling', 'backend', 'webapp'],
    process: [
    ...
    useCases: [
      'B2C apps med brugerengagement',
      'Field service apps til medarbejdere',
      'E-commerce companion apps',
      'Fitness og health tracking',
      'Social og community apps',
      'IoT device control'
    ],
    faq: [
    ...
    seo: {
      title: 'Mobil App Udvikling - Flutter & React Native | Mattias Kieler',
      description: 'Cross-platform app udvikling med Flutter og React Native. iOS og Android apps fra én kodebase. Erfaren freelance app-udvikler i Danmark.',
      ogTitle: 'Mobil App Udvikling - Flutter & React Native',
      ogDescription: 'Native-lignende apps til iOS og Android med Flutter og React Native. Hurtigere time-to-market.'
    }
  },
  {
    slug: 'konsulent',
    ...
    longDescription: `Ikke alle virksomheder har brug for en fuldtids CTO, men alle har brug for solide tekniske beslutninger. Som teknisk konsulent eller fractional CTO hjælper jeg med at træffe de rigtige valg på de rigtige tidspunkter.
...
Typiske engagementer inkluderer teknisk due diligence før investeringer, arkitektur-reviews af eksisterende systemer, hjælp med at skalere udviklingsteams, og rådgivning om modernisering af legacy-systemer.`,
    features: [
      'Arkitektur og systemdesign reviews',
      'Teknologivalg og roadmap-planlægning',
      'Code review og kvalitetssikring',
      'Team mentoring og best practices',
      'Due diligence på teknisk gæld',
      'Vendor selection og outsourcing rådgivning'
    ],
    technologies: ['Arkitektur', 'DevOps', 'CI/CD', 'Agile', 'Scrum', 'Cloud (AWS/GCP/Azure)'],
    benefits: [
      'Undgå dyre fejlbeslutninger tidligt',
      'Bedre teknisk kvalitet i leverancer',
      'Hurtigere onboarding af nye udviklere',
      'Objektiv vurdering uden intern bias'
    ],
    icon: 'i-lucide-lightbulb',
    relatedServices: ['webudvikling', 'backend', 'api-udvikling'],
    process: [
    ...
    useCases: [
      'Teknisk due diligence før investering/acquisition',
      'Arkitektur-review af legacy-systemer',
      'Skalering af udviklingsorganisation',
      'Cloud migration strategi',
      'Fractional CTO for startups',
      'Vendor og contractor management'
    ],
    faq: [
    ...
    seo: {
      title: 'Teknisk Konsulent & Fractional CTO | Mattias Kieler',
      description: 'Erfaren teknisk konsulent og fractional CTO. Arkitektur, code reviews, teknologivalg og team mentoring. Få strategisk teknisk ledelse.',
      ogTitle: 'Teknisk Konsulent & Fractional CTO',
      ogDescription: 'Strategisk teknisk rådgivning. Arkitektur, code reviews og teknologivalg fra erfaren CTO.'
    }
  },
  {
    slug: 'hosting',
    ...
    longDescription: `Med managed hosting tager jeg mig af alt det tekniske - fra serveropsætning til daglige backups og sikkerhedsopdateringer - så du kan fokusere på det, du er bedst til: at drive din forretning.
...
Jeg tilbyder hosting-løsninger der er skræddersyet til Laravel og Nuxt applikationer. Det betyder optimeret performance, korrekt konfiguration og hurtig support når du har brug for det.`,
    features: [
      'Automatiske opdateringer uden nedetid',
      'Daglige backups med 30 dages retention',
      'Gratis SSL-certifikater via Let\'s Encrypt',
      'Proaktiv 24/7 overvågning med alerts',
      'Direkte support uden ventetid',
      'Skalerbar infrastruktur der vokser med dig'
    ],
    technologies: ['Linux', 'Nginx', 'PHP', 'Node.js', 'PostgreSQL', 'Redis', 'Docker'],
    benefits: [
      'Fokuser på din forretning, ikke på servere',
      'Enterprise-grade sikkerhed uden kompleksitet',
      'Hurtig dansk support når du har brug for det',
      'Ingen overraskelser - fast månedlig pris'
    ],
    ...
    useCases: [
      'Laravel applikationer med høje performance-krav',
      'Nuxt/Vue sites med SSR eller SSG',
      'WordPress sites der kræver stabilitet',
      'E-commerce shops med behov for høj oppetid',
      'SaaS-platforme med skalerbare behov'
    ],
    faq: [
    ...
    seo: {
      title: 'Managed Hosting til Laravel & Nuxt | Mattias Kieler',
      description: 'Bekymringsfri managed hosting til din Laravel eller Nuxt applikation. Automatiske opdateringer, daglige backups, SSL, 24/7 monitoring og hurtig dansk support.',
      ogTitle: 'Managed Hosting til Laravel & Nuxt',
      ogDescription: 'Bekymringsfri managed hosting med automatiske opdateringer, daglige backups og dansk support.'
    }
  }
]

export default defineEventHandler((event): ServiceContent | null => {
